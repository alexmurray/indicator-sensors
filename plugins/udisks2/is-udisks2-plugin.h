...
#define IS_TYPE_UDISKS2_PLUGIN (is_udisks2_plugin_get_type())
#define IS_UDISKS2_PLUGIN(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), IS_TYPE_UDISKS2_PLUGIN, IsUDisks2Plugin))
#define IS_UDISKS2_PLUGIN_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), IS_TYPE_UDISKS2_PLUGIN,                    \
                           IsUDisks2PluginClass))
#define IS_IS_UDISKS2_PLUGIN(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), IS_TYPE_UDISKS2_PLUGIN))
#define IS_IS_UDISKS2_PLUGIN_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), IS_TYPE_UDISKS2_PLUGIN))
#define IS_UDISKS2_PLUGIN_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), IS_TYPE_UDISKS2_PLUGIN,                    \
                             IsUDisks2PluginClass))
