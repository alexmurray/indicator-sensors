...
#define IS_TYPE_DBUS_PLUGIN (is_dbus_plugin_get_type())
#define IS_DBUS_PLUGIN(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), IS_TYPE_DBUS_PLUGIN, IsDBusPlugin))
#define IS_DBUS_PLUGIN_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), IS_TYPE_DBUS_PLUGIN, IsDBusPluginClass))
#define IS_IS_DBUS_PLUGIN(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), IS_TYPE_DBUS_PLUGIN))
#define IS_IS_DBUS_PLUGIN_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), IS_TYPE_DBUS_PLUGIN))
#define IS_DBUS_PLUGIN_GET_CLASS(obj)                                          \
  (G_TYPE_INSTANCE_GET_CLASS((obj), IS_TYPE_DBUS_PLUGIN, IsDBusPluginClass))
