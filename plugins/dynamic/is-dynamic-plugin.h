...
#define IS_TYPE_DYNAMIC_PLUGIN (is_dynamic_plugin_get_type())
#define IS_DYNAMIC_PLUGIN(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), IS_TYPE_DYNAMIC_PLUGIN, IsDynamicPlugin))
#define IS_DYNAMIC_PLUGIN_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), IS_TYPE_DYNAMIC_PLUGIN,                    \
                           IsDynamicPluginClass))
#define IS_IS_DYNAMIC_PLUGIN(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), IS_TYPE_DYNAMIC_PLUGIN))
#define IS_IS_DYNAMIC_PLUGIN_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), IS_TYPE_DYNAMIC_PLUGIN))
#define IS_DYNAMIC_PLUGIN_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), IS_TYPE_DYNAMIC_PLUGIN,                    \
                             IsDynamicPluginClass))
