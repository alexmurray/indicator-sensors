...
#define IS_TYPE_APPLICATION (is_application_get_type())
#define IS_APPLICATION(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), IS_TYPE_APPLICATION, IsApplication))
#define IS_APPLICATION_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), IS_TYPE_APPLICATION, IsApplicationClass))
#define IS_IS_APPLICATION(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), IS_TYPE_APPLICATION))
#define IS_IS_APPLICATION_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), IS_TYPE_APPLICATION))
#define IS_APPLICATION_GET_CLASS(obj)                                          \
  (G_TYPE_INSTANCE_GET_CLASS((obj), IS_TYPE_APPLICATION, IsApplicationClass))
