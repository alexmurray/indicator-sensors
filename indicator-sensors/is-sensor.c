...
typedef struct _IsSensorPrivate
{
  gchar *path;
  gchar *label;
  gdouble value;
...
G_DEFINE_TYPE_WITH_PRIVATE(IsSensor, is_sensor, G_TYPE_OBJECT);

static void is_sensor_finalize(GObject *object);
static void is_sensor_get_property(GObject *object, guint property_id,
                                   GValue *value, GParamSpec *pspec);
static void is_sensor_set_property(GObject *object, guint property_id,
...
is_sensor_class_init(IsSensorClass *klass)
{
  ...
  properties[PROP_PATH] = g_param_spec_string(
      "path", "path property", "path of this sensor.", NULL,
      G_PARAM_CONSTRUCT_ONLY | G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_PATH,
                                  properties[PROP_PATH]);
  properties[PROP_LABEL] =
      g_param_spec_string("label", "sensor label", "label of this sensor.",
                          NULL, G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_LABEL,
                                  properties[PROP_LABEL]);
  properties[PROP_VALUE] =
      g_param_spec_double("value", "sensor value", "value of this sensor.",
                          -G_MAXDOUBLE, G_MAXDOUBLE, IS_SENSOR_VALUE_UNSET,
                          G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_VALUE,
                                  properties[PROP_VALUE]);
  properties[PROP_DIGITS] = g_param_spec_uint(
      "digits", "number of digits for this sensor",
      "the number of decimal places to display for this sensor.", 0, G_MAXUINT,
  ...
  properties[PROP_ALARM_VALUE] = g_param_spec_double(
      "alarm-value", "sensor alarm limit", "alarm limit of this sensor.",
      -G_MAXDOUBLE, G_MAXDOUBLE, 0.0,
      G_PARAM_CONSTRUCT | G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_ALARM_VALUE,
                                  properties[PROP_ALARM_VALUE]);
  properties[PROP_ALARM_MODE] = g_param_spec_int(
      "alarm-mode", "sensor alarm mode", "alarm mode of this sensor.",
      IS_SENSOR_ALARM_MODE_DISABLED, IS_SENSOR_ALARM_MODE_HIGH,
      IS_SENSOR_ALARM_MODE_DISABLED,
      G_PARAM_CONSTRUCT | G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_ALARM_MODE,
                                  properties[PROP_ALARM_MODE]);
  properties[PROP_UNITS] =
      g_param_spec_string("units", "sensor units", "units of this sensor.",
                          NULL, G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_UNITS,
                                  properties[PROP_UNITS]);
  properties[PROP_UPDATE_INTERVAL] = g_param_spec_uint(
      "update-interval", "sensor update interval",
      "update interval of this sensor in seconds.", 0, G_MAXUINT, 5,
      G_PARAM_CONSTRUCT | G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_UPDATE_INTERVAL,
                                  properties[PROP_UPDATE_INTERVAL]);
  properties[PROP_ALARMED] = g_param_spec_boolean(
      "alarmed", "is sensor alarmed", "alarmed state of this sensor.", FALSE,
      G_PARAM_READABLE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_ALARMED,
                                  properties[PROP_ALARMED]);
  properties[PROP_ICON] = g_param_spec_string(
      "icon", "sensor icon", "icon of this sensor.", IS_STOCK_CHIP,
      G_PARAM_CONSTRUCT | G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_ICON,
                                  properties[PROP_ICON]);
  properties[PROP_LOW_VALUE] = g_param_spec_double(
      "low-value", "sensor low value", "low value of this sensor.",
      -G_MAXDOUBLE, G_MAXDOUBLE, 0.0,
      G_PARAM_CONSTRUCT | G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_LOW_VALUE,
                                  properties[PROP_LOW_VALUE]);
  properties[PROP_HIGH_VALUE] = g_param_spec_double(
      "high-value", "sensor high value", "high value of this sensor.",
      -G_MAXDOUBLE, G_MAXDOUBLE, 0.0,
      G_PARAM_CONSTRUCT | G_PARAM_READWRITE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_HIGH_VALUE,
                                  properties[PROP_HIGH_VALUE]);
  properties[PROP_ICON_PATH] = g_param_spec_string(
      "icon-path", "sensor icon path", "path to the icon of this sensor.",
      IS_STOCK_CHIP, G_PARAM_READABLE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_ICON_PATH,
                                  properties[PROP_ICON_PATH]);
  properties[PROP_ERROR] =
      g_param_spec_string("error", "sensor error", "error of this sensor.",
                          NULL, G_PARAM_READABLE | G_PARAM_STATIC_STRINGS);
  g_object_class_install_property(gobject_class, PROP_ERROR,
                                  properties[PROP_ERROR]);

  signals[SIGNAL_UPDATE_VALUE] =
      g_signal_new("update-value", G_OBJECT_CLASS_TYPE(klass),
                   G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                   offsetof(IsSensorClass, update_value), NULL, NULL,
...
static void
is_sensor_get_property(GObject *object, guint property_id, GValue *value,
                       GParamSpec *pspec)
{
...
static void
is_sensor_set_property(GObject *object, guint property_id, const GValue *value,
                       GParamSpec *pspec)
{
  IsSensor *self = IS_SENSOR(object);
...
{
  return g_object_new(IS_TYPE_SENSOR, "path", path, "label", NULL, "digits", 1,
                      "value", IS_SENSOR_VALUE_UNSET, "alarm-value", 0.0,
                      "alarm-mode", IS_SENSOR_ALARM_MODE_DISABLED, "units", "?",
                      "update-interval", 5, "icon", IS_STOCK_CHIP, "low-value",
                      0.0, "high-value", 0.0, NULL);
}
...
void
is_sensor_set_label(IsSensor *self, const gchar *label)
{
  IsSensorPrivate *priv;

  g_return_if_fail(IS_IS_SENSOR(self));

  priv = is_sensor_get_instance_private(self);
...
static gdouble
sensor_value_range_normalised(gdouble value, gdouble low_value,
                              gdouble high_value)
{
  return ((value - low_value) / (high_value - low_value));
}

static SensorValueRange
sensor_value_range(gdouble sensor_value, gdouble low_value, gdouble high_value)
{
  gdouble range;
...
static const gchar *const value_overlay_icons[NUM_OVERLAY_ICONS] = {
    "very-low-value-icon", "low-value-icon", "normal-value-icon",
    "high-value-icon", "very-high-value-icon"};

static const gchar *
value_overlay_icon(gdouble value, gdouble low, gdouble high)
{
...
static gboolean
prepare_cache_icon(const gchar *base_icon_name, const gchar *overlay_name,
                   const gchar *icon_path, GError **error)
{
  ...
  base_icon = gtk_icon_theme_load_icon(
      icon_theme, base_icon_name, DEFAULT_ICON_SIZE, DEFAULT_ICON_SIZE, error);
  if (!base_icon)
  {
    goto out;
  }
  overlay_icon = gtk_icon_theme_load_icon(
      icon_theme, overlay_name, DEFAULT_ICON_SIZE, DEFAULT_ICON_SIZE, error);
  ...
  gdk_pixbuf_composite(overlay_icon, new_icon, 0, 0, DEFAULT_ICON_SIZE,
                       DEFAULT_ICON_SIZE, 0, 0, 1.0, 1.0, GDK_INTERP_BILINEAR,
                       255);
...
get_icon_path(IsSensor *self)
{
  ...
  if (!base_name)
  {
    is_warning("sensor", "No base icon for sensor %s [%s]",
               is_sensor_get_label(self), is_sensor_get_path(self));
    icon_path = NULL;
    goto out;
  }
  ...
  cache_dir = g_build_filename(g_get_user_cache_dir(), PACKAGE, "icons", NULL);
  ...
  {
    is_warning("sensor",
               "Couldn't create cache icon %s from base %s and overlay %s for "
               "sensor %s: %s",
               icon_path, base_name, overlay_name, is_sensor_get_path(self),
...
update_icon_path(IsSensor *self)
{
  ...
  if (g_strcmp0(icon_path, priv->icon_path))
  {
    g_free(priv->icon_path);
    priv->icon_path = icon_path;
    icon_path = NULL;
    g_object_notify_by_pspec(G_OBJECT(self), properties[PROP_ICON_PATH]);
  }
  g_free(icon_path);
}
...
update_alarmed(IsSensor *self)
{
  ...
  if (priv->alarmed != alarmed)
  {
    ...
    if (priv->alarmed)
    {
      ...
      {
        priv->disable_alarm_id = g_timeout_add_seconds(
            DEFAULT_ALARM_TIMEOUT, (GSourceFunc)disable_alarm, self);
    ...
    else
    {
      ...
      if (!priv->enable_alarm_id)
      {
        priv->enable_alarm_id = g_timeout_add_seconds(
            DEFAULT_ALARM_TIMEOUT, (GSourceFunc)enable_alarm, self);
        is_debug("sensor", "Alarm triggered - will %sable in %d seconds",
                 alarmed ? "en" : "dis", DEFAULT_ALARM_TIMEOUT);
      }
    }
...
void
is_sensor_set_value(IsSensor *self, gdouble value)
{
  IsSensorPrivate *priv;
...
void
is_sensor_set_digits(IsSensor *self, guint digits)
{
  IsSensorPrivate *priv;
...
is_sensor_get_alarm_value(IsSensor *self)
{
  g_return_val_if_fail(IS_IS_SENSOR(self), 0.0f);
  IsSensorPrivate *priv = is_sensor_get_instance_private(self);
  return priv->alarm_value;
}

void
is_sensor_set_alarm_value(IsSensor *self, gdouble alarm_value)
{
  IsSensorPrivate *priv;
...
is_sensor_get_alarm_mode(IsSensor *self)
{
  ...
  IsSensorPrivate *priv = is_sensor_get_instance_private(self);
  return priv->alarm_mode;
}

void
is_sensor_set_alarm_mode(IsSensor *self, IsSensorAlarmMode alarm_mode)
{
  IsSensorPrivate *priv;
  ...
  if (priv->alarm_mode != alarm_mode)
  {
    ...
    g_object_notify_by_pspec(G_OBJECT(self), properties[PROP_ALARM_MODE]);
    update_alarmed(self);
  }
}
...
void
is_sensor_set_units(IsSensor *self, const gchar *units)
{
  g_return_if_fail(IS_IS_SENSOR(self));
  IsSensorPrivate *priv = is_sensor_get_instance_private(self);
  if (g_strcmp0(units, priv->units) != 0)
  {
    g_free(priv->units);
    priv->units = units ? g_strdup(units) : NULL;
...
is_sensor_get_update_interval(IsSensor *self)
{
  g_return_val_if_fail(IS_IS_SENSOR(self), 0);
  IsSensorPrivate *priv = is_sensor_get_instance_private(self);
  return priv->update_interval;
}

void
is_sensor_set_update_interval(IsSensor *self, guint update_interval)
{
  g_return_if_fail(IS_IS_SENSOR(self));
  IsSensorPrivate *priv = is_sensor_get_instance_private(self);
...
is_sensor_update_value(IsSensor *self)
{
  ...
  if (!priv->last_update || secs - priv->last_update >= priv->update_interval)
  {
...
void
is_sensor_set_icon(IsSensor *self, const gchar *icon)
{
  g_return_if_fail(IS_IS_SENSOR(self));
  IsSensorPrivate *priv = is_sensor_get_instance_private(self);
  if (g_strcmp0(icon, priv->icon) != 0)
  {
    g_free(priv->icon);
...
is_sensor_get_low_value(IsSensor *self)
{
  g_return_val_if_fail(IS_IS_SENSOR(self), 0.0f);
  IsSensorPrivate *priv = is_sensor_get_instance_private(self);
  return priv->low_value;
}

void
is_sensor_set_low_value(IsSensor *self, gdouble low_value)
{
  IsSensorPrivate *priv;
...
is_sensor_get_high_value(IsSensor *self)
{
  g_return_val_if_fail(IS_IS_SENSOR(self), 0.0f);
  IsSensorPrivate *priv = is_sensor_get_instance_private(self);
  return priv->high_value;
}

void
is_sensor_set_high_value(IsSensor *self, gdouble high_value)
{
  IsSensorPrivate *priv;
...
void
is_sensor_set_error(IsSensor *self, const gchar *error)
{
  ...
  if (g_strcmp0(error, priv->error) != 0)
  {
    ...
    g_free(priv->error);
    priv->error = error ? g_strdup(error) : NULL;
