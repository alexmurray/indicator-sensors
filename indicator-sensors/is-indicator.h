...
#define IS_TYPE_INDICATOR (is_indicator_get_type())
#define IS_INDICATOR(obj)                                                      \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), IS_TYPE_INDICATOR, IsIndicator))
#define IS_INDICATOR_CLASS(klass)                                              \
  (G_TYPE_CHECK_CLASS_CAST((klass), IS_TYPE_INDICATOR, IsIndicatorClass))
#define IS_IS_INDICATOR(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), IS_TYPE_INDICATOR))
#define IS_IS_INDICATOR_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_TYPE((klass), IS_TYPE_INDICATOR))
#define IS_INDICATOR_GET_CLASS(obj)                                            \
  (G_TYPE_INSTANCE_GET_CLASS((obj), IS_TYPE_INDICATOR, IsIndicatorClass))
...
typedef enum
{
  ...
  IS_INDICATOR_DISPLAY_ALL =
      (IS_INDICATOR_DISPLAY_VALUE | IS_INDICATOR_DISPLAY_LABEL |
